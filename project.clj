(defproject chestnut-explode "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "chestnut-explode.jar"
  ...
  :profiles {:dev {:repl-options {:init-ns chestnut-explode.server
